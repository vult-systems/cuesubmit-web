...
const defaultValues: FormData = {
  ...
  version: "2026",
  projectPath: "",
  sceneFile: "\\\\10.40.14.25\\RenderOutputRepo\\",
  outputPath: "\\\\10.40.14.25\\RenderOutputRepo\\",
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-6 gap-3">
              <div className="col-span-3 space-y-1">
                ...
                <Input
                  {...register("sceneFile")}
                  placeholder="\\10.40.14.25\RenderOutputRepo\project\scene.ma"
              ...
              <div className="col-span-3 space-y-1">
                ...
                <Input
                  {...register("outputPath")}
                  placeholder="\\10.40.14.25\RenderOutputRepo\project\renders\"
                  className="font-mono text-xs"
                />
              </div>
            </div>
